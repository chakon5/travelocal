...
<div class="grid-container">
    ...
    <div class="item3">
        ...
        <form action="{{ route('acttravel.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="w3-row">
          <div class="w3-half">
            <label for="at_type">ประเภทการท่องเที่ยว</label>
            <select id="typetv_id" name="typetv_id" class="typetv_id">
              @foreach($acttravel as $acttravels)
              <option value={{ $acttravels->typetv_id }}> {{ $acttravels->typetv_id }} {{ $acttravels->typetv_name }}</option>
              @endforeach
          </select>
          </div>
        </div>
        ...
        <div class="w3-row">
          <div class="w3-half">
            ...
            <input type="text" id="at_name" name="at_name" placeholder="ชื่อกิจกรรมการเที่ยว...">
          </div>
          <div class="w3-half">
          ...
          <div class="w3-row">
            <div class="w3-half">
                ...
                <textarea type="text" id="at_detail" name="at_detail" placeholder="รายละเอียด..."></textarea>
            </div>
            </div>
          ...
          <div class="w3-row">
            <div class="w3-half">
              ...
              <textarea type="text" id="at_note" name="at_note" placeholder="หมายเหตุ..."></textarea>
            </div>
            </div>
