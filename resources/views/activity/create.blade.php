    ...
    <div class="item3">
        ...
        <div class="w3-row">
          <div class="w3-half">
            ...
            <input type="text" id="activity_name" name="activity_name" placeholder="ชื่อกิจกรรมเสริม...">
          </div>
            <div class="w3-half">
              <label for="activity_price">ราคา</label>
              <input type="text" id="activity_price" name="activity_price" placeholder="ราคา...">
            </div>
          </div> 
          ...
          <div class="w3-row">
            <div class="w3-half">
                ...
                <textarea type="text" id="activity_detail" name="activity_detail" placeholder="รายละเอียด..."></textarea>
            </div>
            </div>
            ...
            <div class="w3-row">
              <div class="w3-half">
                ...
                <textarea type="text" id="activity_note" name="activity_note" placeholder="หมายเหตุ..."></textarea>
              </div>
              </div>
