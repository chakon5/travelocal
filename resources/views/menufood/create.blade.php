...
<div class="grid-container">
    ...
    <div class="item3">
        ...
        <form action="{{ route('menufood.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="w3-row">
          <div class="w3-half">
            ...
            <input type="text" id="food_name" name="food_name" placeholder="ชื่อเมนูอาหาร...">
          </div>
          <div class="w3-half">
            <label for="food_type">รูปแบบ</label>
            <select id="food_type" name="food_type" class="food_type">
          ...
          <div class="w3-row">
            <div class="w3-half">
                ...
                <textarea type="text" id="food_detail" name="food_detail" placeholder="รายละเอียด..."></textarea>
            </div>
            </div>
          ...
          <div class="w3-row">
            <div class="w3-half">
              ...
              <textarea type="text" id="food_note" name="food_note" placeholder="หมายเหตุ..."></textarea>
            </div>
            </div>
