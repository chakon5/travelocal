    ...
    @endif
        ...
        <thead>
            <tr>
                ...
                <th class="text-left" width="100px">ประเภทห้องพัก</th>
                <th class="text-left" width="100px">หมายเลขห้องพัก</th>
                <th class="text-left" width="120px">จำนวนเข้าพัก</th>
        ...
        <tbody class="table-hover">
            ...
            <tr>                
                ...
                <td class="text-center">
                    <a href="{{url('/showroom/room/'.$row->booking_id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
