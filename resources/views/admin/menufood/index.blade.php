...
<div class="grid-container">
    ...
    <button class="button button3" onclick="location='{{ route('createMenufood') }}'">
    ...
    @endif
        ...
        <thead>
            <tr>
                ...
                <th class="text-left">ชื่อเซ็ทเมนูอาหาร</th>
                {{-- <th class="text-left">รายละเอียดห้องพัก</th> --}}
                <th class="text-left">รูปแบบ</th>
        ...
        <tbody class="table-hover">
            ...
            <tr>
                <td class="text-left">{{$menufoods->firstItem()+$loop->index}}</td>
                ...
                <td class="text-left"><img src="{{asset($row->food_img)}}" alt="" width="80px" height="auto"></td>
                <td class="text-left">
                ...
                <td class="text-center">
                    <a href="{{url('/menufood/edit/'.$row->food_id)}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{url('/menufood/delete/'.$row->food_id)}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
        ...
        <div class="paginate">
        {!! $menufoods->links('pagination::bootstrap-5') !!}
        </div>
