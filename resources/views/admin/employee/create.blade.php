...
<div class="grid-container">
    <div class="item1">
        ...
        <center><p class="top1">เพิ่มข้อมูลพนักงาน</p></center>     
    </div>
    ...
    @csrf
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="employee_name" placeholder="ชื่อจริง...">
            </div>
            <div class="col">
                <label for="employee_lname">นามสกุล</label>
                <input type="text" name="employee_lname" placeholder="นามสกุล...">
            </div>
        @error('employee_name')
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="employee_tel" placeholder="เบอโทรศัพท์...">
            </div>
            <div class="col">
                <label for="employee_address">ที่อยู่</label>
                <input type="text" name="employee_address" placeholder="ที่อยู่...">
            </div>
        @error('employee_tel')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
