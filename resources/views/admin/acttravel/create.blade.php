...
<div class="grid-container">
    ...
    <form action="{{ route('addActtravel') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="acttravel_name" placeholder="ชื่อกิจกรรมการเที่ยว..">
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                ...
                <textarea class="textarea-1" type="text" name="acttravel_list" placeholder="รายการกิจกรรมการเที่ยว..."></textarea>
            </div>
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="acttravel_note" placeholder="หมายเหตุ..">
            </div>
