    ...
    @endif
        ...
        <thead>
            <tr>
                ...
                <th class="text-left" width="150px">ประเภทการท่องเที่ยว</th>
        ...
        <tbody class="table-hover">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="{{url('/acttravel/edit/'.$row->acttravel_id)}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{url('/acttravel/delete/'.$row->acttravel_id)}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
