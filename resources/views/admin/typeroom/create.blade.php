...
<div class="grid-container">
    <div class="item1">
        ...
        <center><p class="top1">เพิ่มข้อมูลประเภทห้องพัก</p></center>     
    </div>
    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" name="typeroom_name" placeholder="ชื่อประเภทห้องพัก..">
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                ...
                <textarea class="textarea-1" type="text" name="typeroom_detail" placeholder="รายละเอียด..."></textarea>
            </div>
