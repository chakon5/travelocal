...
<div class="grid-container">
    <div><center><p class="top1">แสดงข้อมูลประเภทห้องพัก</p></center>
    <button class="button button3" onclick="location='{{ route('createTyperoom') }}'">
        <i class="fa-solid fa-file-circle-plus"></i> เพิ่มข้อมูลประเภทห้องพัก</button>
    </div>
</div> 
    ...
    @endif
        ...
        <tbody class="table-hover">
            ...
            <tr>
                ...
                <td class="text-left">{{$row->typeroom_capacity}}</td>
                <td class="text-left">
                ...
                <td class="text-center">
                    <a href="{{url('/typeroom/edit/'.$row->typeroom_id)}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{url('/typeroom/delete/'.$row->typeroom_id)}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
