...
<div class="grid-container">
    <div class="item1">
        ...
        <center><p class="top1">เพิ่มข้อมูลห้องพัก</p></center>     
    </div>
    ...
    @csrf
            ...
            <div class="col">
                ...
                <select name="typeroom_id" class="select">
                    ...
                    @foreach($typerooms as $row)
                        <option value={{ $row->typeroom_id }}>{{ $row->typeroom_name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col">
                <label for="room_number">หมายเลขห้องพัก</label>
                <input type="text" name="room_number" placeholder="หมายเลขห้องพัก..">
            </div>
        @error('typeroom_id')
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <input type="number" name="room_price" placeholder="ราคาห้องพัก..">
            </div>
        @error('room_contain')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        ...
        <div class="row">
            <div class="col">
                ...
                <textarea class="textarea-1" type="text" name="room_detail" placeholder="รายละเอียดห้องพัก..."></textarea>
            </div>
        @error('room_detail')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
