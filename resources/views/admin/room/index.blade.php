...
<div class="grid-container">
    <div><center><p class="top1">แสดงข้อมูลห้องพัก</p></center>
    <button class="button button3" onclick="location='{{ route('createRoom') }}'">
        <i class="fa-solid fa-file-circle-plus"></i> เพิ่มข้อมูลห้องพัก</button>
    </div>
</div> 
    ...
    @endif
        ...
        <thead>
            <tr>
                ...
                <th class="text-left">ราคาห้องพัก</th>
                <th class="text-left" width="150px" height="auto">รูปภาพห้องพัก</th>
        ...
        <tbody class="table-hover">
            ...
            <tr>
                <td class="text-left">{{$rooms->firstItem()+$loop->index}}</td>
                ...
                <td class="text-center">
                    <a href="{{url('/room/edit/'.$row->room_id)}}" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href="{{url('/room/delete/'.$row->room_id)}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
